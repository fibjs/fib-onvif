...
Cam.prototype._request = function(options, callback) {
	...
	var req_test = http.request("POST", `http://${reqOptions.hostname}:${reqOptions.port}${reqOptions.path}`, {
		"headers": reqOptions.headers,
		"body": options.body,
	});

	const resp = req_test.body.readAll().toString()
	parseSOAPString(resp, callback);
};
